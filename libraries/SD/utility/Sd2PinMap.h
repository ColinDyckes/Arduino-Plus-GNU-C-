...
// Two Wire (aka I2C) ports
uint8_t const SDA_PIN = 24;
uint8_t const SCL_PIN = 25;
...
static const pin_map_t digitalPinMap[] = {
		{&DDRD, &PIND, &PORTD, 2},  // PD2  0
		{&DDRD, &PIND, &PORTD, 3},  // PD3  1
		{&DDRE, &PINE, &PORTE, 6},  // PE6  2
		{&DDRE, &PINE, &PORTE, 5},  // PE5  3
		{&DDRE, &PINE, &PORTE, 2},  // PE2  4
		...
		{&DDRB, &PINB, &PORTB, 3},  // PB3 12
		{&DDRB, &PINB, &PORTB, 1},  // PB1 13
		{&DDRF, &PINF, &PORTF, 0},  // PF0 14
		{&DDRF, &PINF, &PORTF, 1},  // PF1 15
		{&DDRF, &PINF, &PORTF, 2},  // PF2 16
