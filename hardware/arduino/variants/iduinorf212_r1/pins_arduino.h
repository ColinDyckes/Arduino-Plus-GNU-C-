...
#define digitalPinHasPWM(p)         ((p) == 3 ||(p) == 6 ||(p) == 6 ||(p) == 8 ||(p) == 9 ||(p) == 22 ||(p) == 23) ||(p) == 35)
...
const uint8_t PROGMEM digital_pin_to_port_PGM[] = {
	...
	PB	, // PB 4 ** 8 ** D8:PWM8:PCINT4:Timer2 OUTPUTA
	...
	PF	, // PF 6 ** 20 ** A6:VCC_ENC_CONTROL LOW ENABLE
	PF	, // PF 7 ** 21 ** A7:VCC_SD_CONTROL LOW ENABLE
	...
	PG	, // PG 5 ** 35 ** PWM:Timer0 OUTPUTb:5VCTRL_MAX1797
...
const uint8_t PROGMEM digital_pin_to_bit_mask_PGM[] = {
	...
	_BV(4)	, // PB 4 ** 8 ** PWM8:D8:PCINT4:Timer2 OUTPUTA
	...
	_BV(6)	, // PF 6 ** 20 ** A6:VCC_ENC_CONTROL LOW ENABLE
...
const uint8_t PROGMEM digital_pin_to_timer_PGM[] = {
	...
	TIMER2A	, // PB 4 ** 8 ** PWM8:D8:PCINT4:Timer2 OUTPUTA
	...
	NOT_ON_TIMER	, // PF 6 ** 20 ** A6:VCC_ENC_CONTROL LOW ENABLE
